...
public class Preferences {
    ...
    public synchronized String getAppKey(){
        return pref.getString(KEY_APPKEY, Constant.BASE_URL);
    }
    
    public synchronized String getTenantId() {
    	return pref.getString(KEY_TENANT_ID, Constant.BASE_URL);
    }
    ...
    public String getCustomerAccount(){
    	return pref.getString(KEY_CUSTOMER_ACCOUNT, Constant.BASE_URL);
    }
    ...
    public String getNickName(){
       return pref.getString(KEY_NICKNAME, Constant.BASE_URL);
    }
    
	public synchronized String getProjectId(){
		return pref.getString(KEY_PROJECT_ID, Constant.BASE_URL);
	}
